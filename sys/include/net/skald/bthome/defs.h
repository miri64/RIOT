...
#ifndef NET_SKALD_BTHOME_DEFS_H
#define NET_SKALD_BTHOME_DEFS_H
/**
 * @defgroup    ble_skald_bthome_defs BTHome definitions
 * @ingroup     ble_skald_defs
 ...
 *
 * _v_ is the value send, with the type in parenthesis.
 */
typedef enum {
    /* ==================== 0x00 ==================== */
