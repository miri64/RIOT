...
#ifndef NET_SKALD_BTHOME_H
#define NET_SKALD_BTHOME_H
/**
 ...
 *
 * # About
 * This Skald module suports the creation and advertisement of BTHome messages
 * (see https://bthome.io)
 *
 ...
 *                              make the length of the PDU exceed @ref NETDEV_BLE_PDU_MAXLEN
 * @param[in] dev_info          Flags for the device information. Currenlty, no flags are supported.
 *
 * @return The current size of the advertisement on success
 * @return -EMSGSIZE, when @p shortened_name or @p complete_name cause the message to exceed
 ...
 *
 * @return The current size of the advertisement on success
 * @return -EMSGSIZE, when @p data_len cause the message to exceed @ref NETDEV_BLE_PDU_MAXLEN.
 ...
 *
 * @return The current size of the advertisement on success
 * @return -EMSGSIZE, when @p data cause the message to exceed @ref NETDEV_BLE_PDU_MAXLEN.
 *         With NDEBUG=0 an assertion is raised in this case.
 */
