...
#include "net/gnrc/sock_types.h"
#include "net/gnrc/sock_internal.h"
...
int gnrc_sock_recv(gnrc_sock_reg_t *reg, gnrc_pktsnip_t **pkt_out,
...
int gnrc_sock_send(gnrc_pktsnip_t *payload, sock_ip_ep_t *local,
