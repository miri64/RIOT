...
{
    return _netapi_register_cmd(pid, NETAPI_CMD_REG, reg_pid);
}

int netapi_register_current_thread(kernel_pid_t pid)
{
    return _netapi_register_cmd(pid, NETAPI_CMD_REG, thread_getpid());
}

int netapi_unregister(kernel_pid_t pid, kernel_pid_t reg_pid)
{
    return _netapi_register_cmd(pid, NETAPI_CMD_UNREG, reg_pid);
}

int netapi_unregister_current_thread(kernel_pid_t pid)
{
    return _netapi_register_cmd(pid, NETAPI_CMD_UNREG, thread_getpid());
}
