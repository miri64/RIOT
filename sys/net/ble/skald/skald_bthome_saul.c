...
static int _add_button_press(skald_bthome_ctx_t *ctx, uint8_t obj_id, phydat_t *data, uint8_t idx);
static int _add_int8_measurement(skald_bthome_ctx_t *ctx, uint8_t obj_id, phydat_t *data, uint8_t idx);
static int _add_int16_measurement(skald_bthome_ctx_t *ctx, uint8_t obj_id, phydat_t *data, uint8_t idx);
static int _add_uint8_measurement(skald_bthome_ctx_t *ctx, uint8_t obj_id, phydat_t *data, uint8_t idx);
static int _add_uint16_measurement(skald_bthome_ctx_t *ctx, uint8_t obj_id, phydat_t *data, uint8_t idx);
static int _add_uint24_measurement(skald_bthome_ctx_t *ctx, uint8_t obj_id, phydat_t *data, uint8_t idx);
static int _add_div_10_uint16_measurement(skald_bthome_ctx_t *ctx, uint8_t obj_id, phydat_t *data, uint8_t idx);
static int _add_div_10_uint24_measurement(skald_bthome_ctx_t *ctx, uint8_t obj_id, phydat_t *data, uint8_t idx);
static int _add_div_100_uint16_measurement(skald_bthome_ctx_t *ctx, uint8_t obj_id, phydat_t *data, uint8_t idx);
static int _add_div_100_uint24_measurement(skald_bthome_ctx_t *ctx, uint8_t obj_id, phydat_t *data, uint8_t idx);
static int _add_div_1000_uint16_measurement(skald_bthome_ctx_t *ctx, uint8_t obj_id, phydat_t *data, uint8_t idx);
static int _add_div_10000_uint16_measurement(skald_bthome_ctx_t *ctx, uint8_t obj_id, phydat_t *data, uint8_t idx);
...
static int _add_times_10000_uint16_measurement(skald_bthome_ctx_t *ctx, uint8_t obj_id, phydat_t *data, uint8_t idx);
